...
from model_analyzer.constants import SERVER_ONLY_TABLE_DEFAULT_VALUE
...
class Analyzer:
    ...
    def run(self):
        ...
        for model_name in self._config.model_names:
            for run_config in FullRunConfigGenerator(
                ...
                perf_configs = run_config.perf_analyzer_configs()
    ...
    def _export_model_csv(self, inference_writer, gpu_metrics_writer,
        ...
        gpu_table, non_gpu_table = self._result_manager.get_model_tables()
